...
class SurucuProfilScreen extends StatefulWidget {
  const SurucuProfilScreen({super.key});

  @override
  State<SurucuProfilScreen> createState() => _SurucuProfilScreenState();
}

class _SurucuProfilScreenState extends State<SurucuProfilScreen> {
  @override
                ...
                AppCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Divider(height: 24, color: AppColors.gray200),
                      _buildInfoRow(Icons.badge_outlined, 'Rol', 'Toplayıcı / Sürücü'),
                    ],
                  ),
                ),
